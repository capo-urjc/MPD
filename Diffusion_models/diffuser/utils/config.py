...
class ConfigTrainTest(collections.Mapping):
    ...
    def __call__(self, *args, **kwargs):
        train_instance = self._class(path_csv=self._dict['train_path'], *args, **kwargs, **self._dict)
        test_instance = self._class(path_csv=self._dict['test_path'], *args, **kwargs, **self._dict)

        if self._device:
            train_instance = train_instance.to(self._device)
            test_instance = test_instance.to(self._device)
